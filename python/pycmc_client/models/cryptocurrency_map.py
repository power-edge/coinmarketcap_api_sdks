...
class CryptocurrencyMap(object):
    ...
    def __init__(self, id=None, name=None, symbol=None, slug=None, is_active=None, first_historical_data=None, last_historical_data=None, platform=None, _configuration=None):  # noqa: E501
