...
class GlobalMetricsQuotesLatest(object):
    ...
    def __init__(self, btc_dominance=None, eth_dominance=None, active_cryptocurrencies=None, active_market_pairs=None, active_exchanges=None, last_updated=None, quote=None, _configuration=None):  # noqa: E501
