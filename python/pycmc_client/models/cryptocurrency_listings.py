...
class CryptocurrencyListings(object):
    ...
    def __init__(self, id=None, name=None, symbol=None, slug=None, cmc_rank=None, num_market_pairs=None, circulating_supply=None, total_supply=None, max_supply=None, last_updated=None, date_added=None, tags=None, platform=None, quote=None, _configuration=None):  # noqa: E501
