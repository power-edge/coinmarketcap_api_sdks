...
class CryptocurrencyInfoUrls(object):
    ...
    def __init__(self, website=None, explorer=None, source_code=None, message_board=None, chat=None, announcement=None, reddit=None, twitter=None, _configuration=None):  # noqa: E501
