...
class Quote(object):
    ...
    def __init__(self, price=None, volume_24h=None, percent_change_1h=None, percent_change_24h=None, percent_change_7d=None, market_cap=None, last_updated=None, _configuration=None):  # noqa: E501
