...
class CryptocurrencyInfo(object):
    ...
    def __init__(self, id=None, name=None, symbol=None, category=None, slug=None, logo=None, tags=None, description=None, date_added=None, platform=None, urls=None, _configuration=None):  # noqa: E501
